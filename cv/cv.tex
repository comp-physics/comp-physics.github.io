...
\begin{center}
    \begin{tabular}{ r l l c c }
        ...
        Fall 2023   & CX/MATH4640   & Numerical Analysis I      & \phantom{1}53 \\
        Spring 2023 & CSE6730       & Modeling \& Simulation    & 146           \\
        Fall 2022   & CX/MATH4640   & Numerical Analysis I      & \phantom{1}36 \\
        Fall 2021   & CX/MATH4640   & Numerical Analysis I      & \phantom{1}43 \\
        \hline\hline
    \end{tabular}
    \vspace{3ex}
    \linebreak 
    \textbf{VIP Instructor:} 2022--Present, VIP[2/3/4]60[1/2], Team Phoenix Cluster Competition Team
\end{center}
...
\begin{itemize}
    ...
    \item (2023--24) co-PI: DARPA ``\textit{Quantum eigensolvers in fluid-dynamic computations and applications}'' ($\$300$K), PI B.~Gard (GTRI), SHB~Share:~$\$100$K
...
\begin{itemize}
    \item (2021,22,23) PI: ACCESS/XSEDE TG-PHY210084, ``\textit{High-fidelity simulation of high-speed flowing dispersions via a stochastic sub-grid model}''  (1.2M Node Hours)
    \item (2021,22,23) PI: Oak Ridge National Lab CFD154, Director's Discretionary, ``\textit{Accelerated sub-grid multi-component flow physics}'' (20K node hours)
...
\begin{itemize}
    \item (2022--Present) Panel Referee, ACCESS Maximize
    \item (2021--Present) Mentor, GPU Hackathons (with Oak Ridge National Lab, NVIDIA, NASA)
...
\printbibliography[type=article,title={Journal articles},resetnumbers=true,heading=subbibnumbered]

\newrefcontext[labelprefix=P]
\printbibliography[title={Heavily reviewed conference papers},resetnumbers=true,filter=heavy,heading=subbibnumbered]
