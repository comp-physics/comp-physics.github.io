...
\begin{itemize}
    ...
    \item (2024) PI: Lab Directed Research and Development (Lawrence Livermore National Laboratories subcontract), ``\textit{Accelerated, Compressed, and Regularized Computation of Kinetic-based PDEs}'' ($\$80$K)
