...
\begin{itemize}
    ...
    \item (2021--2024) PI: ACCESS-CI Discovery TG-PHY210084, ``\textit{High-fidelity simulation of high-speed flowing dispersions via a stochastic sub-grid model}'' (10K~GPU Hours, 20K~CPU Hours, $\$7.5$K value)
