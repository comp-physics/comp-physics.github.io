...
\begin{itemize}
    ...
    \item (2023--Present) Adjunct Assistant Professor (0\%), Daniel Guggenheim School of Aerospace Engineering, College of Engineering, \GIT
...
\begin{itemize}
    \item (2023--27) co-PI: DOD ONR MURI N00014-23-12501 (subcontract), ``\textit{Combustion of solid fuels in high enthalpy flow}'' ($\$3.8$M) PI:~G.~Young (Virginia Polytechnic Institute and State University), SHB Share: $\$270$K
...
\begin{itemize}
    \item (2021,22,23) PI: Oak Ridge National Lab CFD154, Director's Discretionary, ``\textit{Accelerated sub-grid multi-component flow physics}'' (50K node hours)
    \item (2021,22,23) PI: ACCESS TG-PHY210084, ``\textit{High-fidelity simulation of high-speed flowing dispersions via a stochastic sub-grid model}'' (1.2M Node Hours)
...
\begin{itemize}
    ...
    \item (2021, 2022, 2023) Mentor, GPU Hackathons (with Oak Ridge National Lab, NVIDIA, NASA)
