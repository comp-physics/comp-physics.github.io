...
\begin{itemize}
    \item (2024--Present) PI: ACCESS-CI Maximize TG-PHY240200, ``\textit{Direct simulation of compressible multiphase flow}'' (225K~GPU Hours, 55K~CPU Hours, $\$119K$ value)
    ...
    \item (2021--2024) PI: ACCESS-CI Discovery TG-PHY210084, ``\textit{High-fidelity simulation of high-speed flowing dispersions via a stochastic sub-grid model}'' (10K~GPU Hours, 20K~CPU Hours, $\$7.5K$ value)
