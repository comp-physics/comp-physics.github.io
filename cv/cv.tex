...
\begin{itemize}
    \item (2024--29) Senior personnel: DARPA Young Faculty Award ``\textit{Squid-inspired nozzles for enhanced  efficiency and thrust in rotary propulsors}'' ($\$1$M), PI:~S.~Bhamla (GT), SHB~Share: $\$200$K Y1--3
