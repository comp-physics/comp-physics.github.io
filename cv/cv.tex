...
\begin{itemize}
    \item (2023) Qualifying exam; Grayson Harrington (CoC CSE)
    \item (2023) M.S.\ Thesis Proposal; Felix Luo (CoE AE)
    \item (2023) Dissertation Proposal; Liana Hatoum (CoE BME)
    \item (2022) Qualifying exam; Anand Radhakrishnan (CoC CSE)
