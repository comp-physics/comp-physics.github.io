...
\begin{itemize}
    ...
    \item (2024--Present) PI: ACCESS-CI Discovery TG-PHY210084, ``\textit{High-fidelity simulation of high-flowing dispersions}'' (3M~ACCESS Credits, $\$24$K value)
...
\begin{itemize}
    ...
    \item (2024) Ph.D.\ Qualifying exam; Lynn Jin (CoS Physics)
    \item (2024) Ph.D.\ Qualifying exam; Sijian Tan (CoE AE)

    \item (2023) Ph.D.\ Thesis defense;  Fatima Ezahra Chrit (CoE ME)
    \item (2023) M.S.\  Thesis defense;  Felix Luo (CoE AE)
    \item (2023) M.S.\  Thesis proposal; Felix Luo (CoE AE)
    \item (2023) Ph.D.\ Thesis proposal; Liana Hatoum (CoE BME)
    ...
    \item (2022) Ph.D.\ Thesis defense;  Achyut Panchal (CoE AE)
    \item (2022) Ph.D.\ Thesis defense;  Wangwei Lan (CoS Physics)
    \item (2022) Ph.D.\ Thesis proposal; Johnie Sublett (CoC CSE)
