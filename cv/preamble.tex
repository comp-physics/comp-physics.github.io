...
\newcommand\UTA{The University of Texas at Austin\xspace}
\newcommand\UT{\mbox{UT Austin}\xspace}
% Not \mbox'd: these are long enough that forbidding a line break overflows the margin.
\newcommand\Walker{Walker Department of Mechanical Engineering\xspace}
\newcommand\Oden{Oden Institute for Computational Engineering and Sciences\xspace}
...
\makeauthorsbold{Le Berre,Bati,Chrit,Lee,Kocherla,Radhakrishnan,Arias,Song,Wilfong,Yu,Panchal,Zeng,Kothari,Sinha,Chu,Manasreh,Gupta,Adam,{*}Wilfong,{*}Radhakrishnan,{*Le Berre},Vickers,Prathi,{*}Yu,{*}Chu}
...
\cfoot{\color{silver}Latest at \href{https://comp-physics.group/cv.pdf}{\tt comp-physics.group/cv.pdf}}
